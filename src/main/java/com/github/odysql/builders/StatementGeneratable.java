...
interface StatementGeneratable {
     ...
     * {@link com.github.odysql.builders.StatementGeneratable#fill(PreparedStatement)}
     * to fill the designed parameter (? character).
     * 
     ...
     *                      parameter.
     */
    public default PreparedStatement fill(PreparedStatement statement) throws SQLException {
        int index = 0;
