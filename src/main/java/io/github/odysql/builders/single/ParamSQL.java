...
import io.github.odysql.models.MinimalDataSource;
...
public final class ParamSQL {
     ...
     *                      parameter.
     */
    public PreparedStatement prepare(MinimalDataSource ds) throws SQLException {
        return this.prepare(ds.getConnection());
    }
     ...
     *                      parameter.
     */
    public PreparedStatement prepare(MinimalDataSource ds, int autoGeneratedKeys) throws SQLException {
        return this.prepare(ds.getConnection(), autoGeneratedKeys);
    }
}
